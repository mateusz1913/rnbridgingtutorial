...
public class AndroidNativeListClassicViewFragment extends Fragment {
    public static final String NAME = "AndroidNativeListClassicView";
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerView recyclerView = view.findViewById(R.id.list_classic);
    ...
    public void setData(ReadableArray data) {
        ...
        RecyclerView recyclerView = requireView().findViewById(R.id.list_classic);
