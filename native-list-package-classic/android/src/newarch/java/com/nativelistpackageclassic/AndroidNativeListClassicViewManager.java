...
import com.facebook.react.viewmanagers.AndroidNativeListClassicViewManagerDelegate;
import com.facebook.react.viewmanagers.AndroidNativeListClassicViewManagerInterface;

@ReactModule(name = AndroidNativeListClassicViewFragment.NAME)
public class AndroidNativeListClassicViewManager extends SimpleViewManager<FragmentContainerView> implements AndroidNativeListClassicViewManagerInterface<FragmentContainerView> {
    private final ViewManagerDelegate<FragmentContainerView> mDelegate = new AndroidNativeListClassicViewManagerDelegate(this);
    ...
    public String getName() {
        return AndroidNativeListClassicViewFragment.NAME;
    }
    ...
    public void setData(FragmentContainerView view, @Nullable ReadableArray data) {
        ...
        if (fragmentManager != null) {
            final AndroidNativeListClassicViewFragment fragment = findFragment(fragmentManager, view);
    ...
    private void mountFragment(FragmentContainerView view) {
        ...
        if (fragmentManager != null) {
            ...
            final AndroidNativeListClassicViewFragment newFragment = new AndroidNativeListClassicViewFragment();
            view.removeAllViews();
    ...
    private String getFragmentTag(View view) {
        return "AndroidNativeListClassicViewFragment-" + view.getId();
    }
}
