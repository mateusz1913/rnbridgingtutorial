...
@interface RNSampleNativeListClassicViewViewController () <UICollectionViewDataSource>
@end

@implementation RNSampleNativeListClassicViewViewController {
...
- (void)didMoveToParentViewController:(UIViewController *)parent
{
    if (parent != nil) {
        ...
        [newCollectionView registerClass:[NativeListClassicCell class] forCellWithReuseIdentifier:[RNSampleNativeListClassicViewViewController cellIdentifier]];
...
{
    NativeListClassicCell *myCell = (NativeListClassicCell *)[collectionView dequeueReusableCellWithReuseIdentifier:[RNSampleNativeListClassicViewViewController cellIdentifier] forIndexPath:indexPath];
