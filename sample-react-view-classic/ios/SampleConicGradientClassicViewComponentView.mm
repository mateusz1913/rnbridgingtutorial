...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        SampleConicGradientClassicView *view = [[SampleConicGradientClassicView alloc] initWithFrame:CGRectZero];
...
- (void)updateProps:(Props::Shared const &)props oldProps:(Props::Shared const &)oldProps
{
    ...
    SampleConicGradientClassicView *view = (SampleConicGradientClassicView *)self.contentView;
