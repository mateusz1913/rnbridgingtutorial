...
public class SampleConicGradientClassicView extends ReactViewGroup {
  ...
  public static final String NAME = "SampleConicGradientClassicView";
  
  public SampleConicGradientClassicView(ReactContext reactContext) {
    super(reactContext);
