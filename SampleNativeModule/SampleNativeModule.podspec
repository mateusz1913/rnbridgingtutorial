...
Pod::Spec.new do |s|
  ...
  if fabric_enabled
    ...
    s.pod_target_xcconfig    = {
      ...
      "DEFINES_MODULE" => "YES",
      "SWIFT_OBJC_INTERFACE_HEADER_NAME" => "SampleNativeModule-Swift.h",
      # This is handy when we want to detect if new arch is enabled in Swift code
      # and can be used like:
      # #if SAMPLE_MODULE_NEW_ARCH_ENABLED
      # // do sth when new arch is enabled
      # #else
      # // do sth when old arch is enabled
      # #endif
      "OTHER_SWIFT_FLAGS" => "-DSAMPLE_MODULE_NEW_ARCH_ENABLED"
    }
