 ...
 */
public class SampleAppInfoClassicModuleImpl {
    private final ReactApplicationContext reactContext;

    public static final String NAME = "SampleAppInfoClassicModule";

    public SampleAppInfoClassicModuleImpl(ReactApplicationContext reactContext) {
