 ...
 */
public class ScreenOrientationClassicModuleImpl {
    private final ReactApplicationContext reactContext;

    public static final String NAME = "ScreenOrientationClassicModule";
    public static final String EVENT_NAME = "onScreenOrientationClassicModuleChange";
    public static final String EVENT_KEY = "value";

    public ScreenOrientationClassicModuleImpl(ReactApplicationContext reactContext) {
