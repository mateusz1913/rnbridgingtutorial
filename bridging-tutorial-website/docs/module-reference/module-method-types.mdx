...
export interface Spec extends TurboModule {
  ...
  myAwesomeVoidMethodWithArguments(
    numArg: number,
    objArg: { firstObjProp: string; secondObjProp?: boolean }
  ): void;
}
...
export interface Spec extends TurboModule {
  ...
  myAwesomeSyncMethodWithArguments(
    numArg: number,
    objArg: { firstObjProp: string; secondObjProp?: boolean }
  ): number;
}
...
export interface Spec extends TurboModule {
  ...
  myAwesomePromiseMethodWithArguments(
    numArg: number,
    objArg: { firstObjProp: string; secondObjProp?: boolean }
  ): Promise<boolean>;
}
...
export interface Spec extends TurboModule {
  ...
  myAwesomeCallbackMethodWithArguments(
    numArg: number,
    objArg: { firstObjProp: string; secondObjProp?: boolean },
    myResultCallback: () => void
  ): void;
}
