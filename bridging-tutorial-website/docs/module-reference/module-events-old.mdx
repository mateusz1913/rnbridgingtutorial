---
sidebar_label: Module events (old arch)
sidebar_position: 6
title: Module events (old arch)
---
...
It takes event name and an object payload (NSDictionary type), which will be send to JS listener.
