...
React Native is a great abstraction that allows many JS developers to write mobile apps which:
...
**That native code still has to be bridged.**

Luckily, Expo folks did tremendous job by creating [Expo Modules](https://docs.expo.dev/modules/overview).
It's oriented around modern native languages (Swift & Kotlin), with nice DSL and without big boilerplate, it lets you focus on the most important thing - exposing platform code, to the React Native app.
