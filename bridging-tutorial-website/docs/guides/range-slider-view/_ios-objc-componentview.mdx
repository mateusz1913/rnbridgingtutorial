...
If you take a closer look, we override two methods related to the child components (`- mountChildComponentView:index:` and `- unmountChildComponentView:index:`).
