...
Let's go to `AppInfoTurboPackage.java` and add our new module.

```java title="android/src/main/java/com/appinfopackage/AppInfoTurboPackage.java"
...
To export the module, we need to return it from `getModule` method inside `AppInfoTurboPackage`, if it's requested
