...
Additionally, to use Swift `RangeDatePickerModuleImpl` class, we must do "forward-declaration" (check out Apple's Swift-ObjC interop [dedicated docs section](https://developer.apple.com/documentation/swift/importing-swift-into-objective-c#Include-Swift-Classes-in-Objective-C-Headers-Using-Forward-Declarations)).
...
- importing swift classes with `#import "RangeDatePickerPackage-Swift.h"`
