...
And to consume the result from the picker, the module-implementation class needs to implement [`UIDocumentPickerDelegate`](https://developer.apple.com/documentation/uikit/uidocumentpickerdelegate).
