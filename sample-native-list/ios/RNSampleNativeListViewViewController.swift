...
extension RNSampleNativeListViewViewController : UICollectionViewDataSource {
    public func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return self.data.count
    }
    
    public func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let myCell = collectionView.dequeueReusableCell(withReuseIdentifier: RNSampleNativeListViewViewController.CELL_IDENTIFIER, for: indexPath) as! NativeListCell
...
@objc(RNSampleNativeListViewViewController)
public class RNSampleNativeListViewViewController : UIViewController {
    ...
    public override func didMove(toParent parent: UIViewController?) {
        if parent != nil {
            ...
            collectionView.register(NativeListCell.self, forCellWithReuseIdentifier: RNSampleNativeListViewViewController.CELL_IDENTIFIER)
