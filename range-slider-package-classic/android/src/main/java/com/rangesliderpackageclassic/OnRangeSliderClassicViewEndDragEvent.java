...
public class OnRangeSliderClassicViewEndDragEvent extends Event<OnRangeSliderClassicViewEndDragEvent> {
    ...
    public static final String NAME = "topRangeSliderClassicViewEndDrag";
    public static final String EVENT_PROP_NAME = "onRangeSliderClassicViewEndDrag";

    public OnRangeSliderClassicViewEndDragEvent(
        int surfaceId,
        int viewId,
