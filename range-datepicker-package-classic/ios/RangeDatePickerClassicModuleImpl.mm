...
#import "RangeDatePickerPackageClassic-Swift.h"
 ...
 */
@implementation RangeDatePickerClassicModuleImpl
...
- (void)showRangeDatePickerWithTitle:(NSString *)title
{
    ...
    if (presentedViewController == nil) {
        [self.delegate onError:[[NSError alloc] initWithDomain:@"RangeDatePickerClassicModuleImpl" code:1234 userInfo:nil]];
        return;
    }
