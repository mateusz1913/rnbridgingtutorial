 ...
 */
public class RangeDatePickerClassicModuleImpl {
    private final ReactApplicationContext reactContext;
  
    @Nullable
    private Callback mCallback = null;

    public static final String NAME = "RangeDatePickerClassicModule";
    ...
    public RangeDatePickerClassicModuleImpl(ReactApplicationContext reactContext) {
